...
export function CodeBlockElement(props) {
...
function CodeBlockCombobox() {
  ...
  const items = React.useMemo(() =>
    languages.filter((language) =>
      !searchValue ||
      language.label.toLowerCase().includes(searchValue.toLowerCase())), [searchValue]);
...
export function CodeLineElement(props) {
  return <PlateElement {...props} />;
}

export function CodeSyntaxLeaf(props) {
