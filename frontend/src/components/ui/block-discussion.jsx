...
const BlockCommentContent = ({
    ...
    const resolvedSuggestions = useResolveSuggestion(
        suggestionNodes,
        blockPath
    );
...
function BlockComment({ discussion, isLast }) {
...
const useResolvedDiscussion = (commentNodes, blockPath) => {
