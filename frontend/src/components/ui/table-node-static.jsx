...
export function TableElementStatic({ children, ...props }) {
...
export function TableCellElementStatic({ isHeader, ...props }) {
...
export function TableCellHeaderElementStatic(props) {
