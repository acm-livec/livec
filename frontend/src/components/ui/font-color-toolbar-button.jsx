...
export function FontColorToolbarButton({ children, nodeType, tooltip }) {
    ...
    const color = useEditorSelector(
        (editor) => editor.api.mark(nodeType),
        [nodeType]
    );
...
function ColorInput({ children, className, value = '#000000', ...props }) {
