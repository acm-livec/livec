...
export const TableElement = withHOC(
    TableProvider,
    function TableElement({ children, ...props }) {
...
export function TableRowElement(props) {
    const { element } = props;
    const readOnly = useReadOnly();
    const selected = useSelected();
    const editor = useEditorRef();
...
export function TableCellElement({ isHeader, ...props }) {
                        ...
                        <>
                            ...
                            <div
                                className={cn(
                                    ...
                                    'right-[-1.5px]',
                                    columnResizeVariants({ colIndex: colIndex })
                                )}
                            />
                            {colIndex === 0 && (
                                <div
...
export function TableCellHeaderElement(props) {
