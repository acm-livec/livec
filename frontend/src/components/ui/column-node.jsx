...
export const ColumnElement = withHOC(ResizableProvider, function ColumnElement(props) {
...
export function ColumnGroupElement(props) {
  return (
...
const DoubleColumnOutlined = (props) => (
  <svg
    fill="none"
    height="16"
    viewBox="0 0 16 16"
...
const ThreeColumnOutlined = (props) => (
  <svg
    fill="none"
    height="16"
    viewBox="0 0 16 16"
...
const RightSideDoubleColumnOutlined = (props) => (
  <svg
    fill="none"
    height="16"
    viewBox="0 0 16 16"
...
const LeftSideDoubleColumnOutlined = (props) => (
  <svg
    fill="none"
    height="16"
    viewBox="0 0 16 16"
...
const DoubleSideDoubleColumnOutlined = (props) => (
  <svg
    fill="none"
    height="16"
    viewBox="0 0 16 16"
