...
export function BlockSuggestion({ element }) {
...
export function BlockSuggestionCard({ idx, isLast, suggestion }) {
...
export const useResolveSuggestion = (suggestionNodes, blockPath) => {
    ...
    const resolvedSuggestion = React.useMemo(() => {
        const map = getOption('uniquePathMap');
        ...
        suggestionIds.forEach((id) => {
            ...
            const comments =
                discussions.find((s) => s.id === id)?.comments || [];
...
export const isResolvedSuggestion = (suggestion) => {
