...
export default function PlateEditor({ content = [], LOCAL_STORAGE_KEY, action }) {
    ...
    return (
        ...
        >
            <FlexColumn className="document--computer-science flex flex-col h-full gap-5">
                <EditorContainer>
                    <Editor className="p-5" variant="none" placeholder="Start typing..." />
                </EditorContainer>
